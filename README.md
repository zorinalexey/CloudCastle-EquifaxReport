...
/**
 * Получить конфигурацию для генератора
 */
...
/**
 * Количество клиентов по которым производится выгрузка
 */
$countReports = 20;

/**
 * В цикле формируем и добавляем отчеты в массив по каждому клиенту
 */
