...
for ($i = 0; $i < $countReports; $i++) {
    ...
    $event->action = 'A';
    $event->event = '2.1';
    $event->action_reason = 'Изменились сведения об условиях обязательства субъекта';
     ...
     * Возможные значения по справочнику 3.2 :
     ...
     * Возможные значения по справочнику 3.3 :
     * 1 - Безработный
     ...
     * Возможные значения по справочнику 3.4 :
     ...
     * 9 - Принято решение о не начислении процентов
     * 10 - Уменьшение срока
     * 11 - Увеличение срока
     ...
     */
    $report->base_part->contract->contract_changes->special_type = 11;
    /*
     * Описание иного изменения договора
     */
    $report->base_part->contract->contract_changes->type_text = 'Пролонгация';
    /*
     ...
     */
    $report->base_part->contract->payment_terms->grace_end_date = date('d.m.Y', strtotime('15.01.2023'));
    /*
